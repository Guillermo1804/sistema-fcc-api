...
class Materias(models.Model):
    ...
    materias_dia = models.TextField(null=True, blank=True)
    horario_inicio = models.DateTimeField(auto_now_add=False, null=True, blank=True)
    horario_final = models.DateTimeField(auto_now_add=False, null=True, blank=True)
